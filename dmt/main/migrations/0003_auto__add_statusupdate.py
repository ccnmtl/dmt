...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_statusupdate', (
            ...
            ('body', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'main', ['StatusUpdate'])


    def backwards(self, orm):
        # Deleting model 'StatusUpdate'
        db.delete_table(u'main_statusupdate')
